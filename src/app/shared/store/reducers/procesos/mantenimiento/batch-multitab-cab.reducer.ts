...
import { BatchMultitabCabActions, actions } from '../../../actions/procesos/mantenimiento/batch-multitab-cab.actions';
import { RESOURCE_ACTIONS } from '../../../../utils';
import { State } from '../../entity-state.model';

const INITIAL_STATE: State<BatchMultitabCab> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function batchMultitabCabReducer(state = INITIAL_STATE, action: BatchMultitabCabActions): State<BatchMultitabCab> {
  switch (action.type) {
    case actions.RESET:
