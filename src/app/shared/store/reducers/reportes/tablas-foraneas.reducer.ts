...
import { TablasForaneasActions, actions } from '../../actions/reportes/tablas-foraneas.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { State } from '../entity-state.model';

const INITIAL_STATE: State<TablasForaneas> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function tablasForaneasReducer(state = INITIAL_STATE, action: TablasForaneasActions): State<TablasForaneas> {
  switch (action.type) {
    ...
    case actions.GET_ALL_FAIL:
      ...
      case actions.GET_CRITERIO_FAIL:
        ...
        case actions.UPDATE_SUCCESS: {
          const index = state.data.findIndex(b => b.idRelacionTablaFk === state.selected.idRelacionTablaFk);
        ...
        case actions.DELETE_SUCCESS: {
          const data = state.data.filter(b => b.idRelacionTablaFk !== state.selected.idRelacionTablaFk);
          return {
            ...state,
            data,
            selected: null,
