...
import { PerfilRepActions, actions  } from '../../actions/reportes/perfil-rep.actions';

const INITIAL_STATE: State<PerfilRep> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function PerfilRepReducer(state = INITIAL_STATE, action: PerfilRepActions): State<PerfilRep> {
  switch (action.type) {
    case actions.RESET:
