...
import { CampoActions, actions  } from '../../actions/reportes/campo.actions';

const INITIAL_STATE: State<Campo> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function campoReducer(state = INITIAL_STATE, action: CampoActions): State<Campo> {
  switch (action.type) {
    ...
    case actions.GET_PERMITED_SUCCESS:
      return {
        ...state,
        data: action.payload,
        loading: false,
    ...
    case actions.GET_PERMITED_FAIL:
      return {
        ...state,
        data: [],
        loading: false,
    ...
    case actions.DELETE_SUCCESS: {
      const data = state.data.filter(b => b.idTabla !== state.selected.idTabla);
      return {
        ...state,
        data,
        selected: null,
