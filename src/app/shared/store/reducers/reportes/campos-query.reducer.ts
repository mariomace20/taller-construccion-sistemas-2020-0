...
import { CampoQueryActions, actions } from '../../actions/reportes/campos-query.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { State } from '../entity-state.model';

const INITIAL_STATE: State<CampoQuery> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function camposQueryReducer(state = INITIAL_STATE, action: CampoQueryActions): State<CampoQuery> {
  switch (action.type) {
