...
import { CondicionQueryActions,actions } from '../../actions/reportes/condicion.actions';
import { CondicionQuery } from '../../../../reportes/user/models/condicion.model';

const INITIAL_STATE: State<CondicionQuery> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function condicionQueryReducer(state = INITIAL_STATE, action: CondicionQueryActions): State<CondicionQuery> {
  switch (action.type) {
    ...
    case actions.GET_ALL_FAIL:
      ...
      case actions.GET_CRITERIO_FAIL:
        ...
        case actions.UPDATE_SUCCESS: {
          //const index = state.data.findIndex(b => b.idCampoQuery === state.selected.idCampoQuery);
          /*if (index >= 0) {
            const data = [
        ...
        case actions.DELETE_SUCCESS: {
          //const data = state.data.filter(b => b.idCampoQuery !== state.selected.idCampoQuery);
          return {
            ...state,
            data,
            selected: null,
