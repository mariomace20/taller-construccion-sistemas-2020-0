...
import { OperadorActions, actions } from '../../actions/reportes/operador.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { State } from '../entity-state.model';

const INITIAL_STATE: State<Operador> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function operadorReducer(state = INITIAL_STATE, action: OperadorActions): State<Operador> {
  switch (action.type) {
    case actions.GET_BY_TIPO_DATO:
      return {
        ...state,
    ...
    case actions.GET_BY_TIPO_DATO_SUCCESS:
      return {
        ...state,
        data: action.payload,
        loading: false,
    ...
    case actions.GET_BY_TIPO_DATO_FAIL:
      return {
        ...state,
        data: [],
        loading: false,
