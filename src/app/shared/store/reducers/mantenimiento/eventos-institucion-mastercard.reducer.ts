...
import { EventosInstitucionMastercardActions, actions } from '../../actions/mantenimiento/eventos-institucion-mastercard.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { State } from '../entity-state.model';

const INITIAL_STATE: State<EventosInstitucionMastercard> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function eventosInstitucionMastercardReducer(state = INITIAL_STATE, action: EventosInstitucionMastercardActions): State<EventosInstitucionMastercard> {
  switch (action.type) {
    case actions.RESET:
