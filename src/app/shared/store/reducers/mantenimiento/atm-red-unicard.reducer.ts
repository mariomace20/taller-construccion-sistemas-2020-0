...
import { AtmRedUnicardActions, actions } from '../../actions/mantenimiento/atm-red-unicard.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { State } from '../entity-state.model';

const INITIAL_STATE: State<AtmRedUnicard> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function atmRedUnicardReducer(state = INITIAL_STATE, action: AtmRedUnicardActions): State<AtmRedUnicard> {
  switch (action.type) {
    case actions.RESET:
