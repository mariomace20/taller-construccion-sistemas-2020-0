...
import { EventosTransaccionVisaActions, actions } from '../../actions/mantenimiento/eventos-transaccion-visa.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { State } from '../entity-state.model';

const INITIAL_STATE: State<EventosTransaccionVisa> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function eventosTransaccionVisaReducer(state = INITIAL_STATE, action: EventosTransaccionVisaActions): State<EventosTransaccionVisa> {
  switch (action.type) {
    case actions.RESET:
