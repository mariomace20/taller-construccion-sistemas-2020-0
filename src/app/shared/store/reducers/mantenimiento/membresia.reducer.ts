...
import { MembresiaActions, actions } from '../../actions/mantenimiento/membresia.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { State } from '../entity-state.model';

const INITIAL_STATE: State<Membresia> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function membresiaReducer(state = INITIAL_STATE, action: MembresiaActions): State<Membresia> {
  switch (action.type) {
    case actions.RESET:
