import { IncomingVisaTC10TCR0 } from '../../../../consultas/models';
import { IncomingVisaTC10TCR0Actions, actions } from '../../actions/consultas/incoming-visa-tc10-tcr0.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { ConsultaState } from '../entity-state.model';

const INITIAL_STATE: ConsultaState<IncomingVisaTC10TCR0> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function incomingVisaTC10TCR0Reducer(state = INITIAL_STATE, action: IncomingVisaTC10TCR0Actions): ConsultaState<IncomingVisaTC10TCR0> {
  switch (action.type) {
    case actions.RESET:
      return {
      ...INITIAL_STATE
