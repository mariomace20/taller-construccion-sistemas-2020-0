import { Observada, DetalleObservada } from '../../../../consultas/models';
import { ConsultaState } from '../entity-state.model';
import { ObservadaActions, actions } from '../../actions/consultas/observada.actions';
import { RESOURCE_ACTIONS } from '../../../utils';

export const INITIAL_STATE: ConsultaState<Observada> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function consultaObservadaReducer(state = INITIAL_STATE, action: ObservadaActions): ConsultaState<Observada> {
  switch (action.type) {
    case actions.RESET:
      return {
      ...INITIAL_STATE
