import { DcinCharge } from '../../../../consultas/models';
import { DcinChargeActions, actions } from '../../actions/consultas/dcin-charge.actions';
import { RESOURCE_ACTIONS } from '../../../utils';
import { ConsultaState } from '../entity-state.model';

export const INITIAL_STATE: ConsultaState<DcinCharge> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function dcinChargeReducer(state = INITIAL_STATE, action: DcinChargeActions): ConsultaState<DcinCharge> {
  switch (action.type) {
    case actions.RESET:
      return {
      ...INITIAL_STATE
