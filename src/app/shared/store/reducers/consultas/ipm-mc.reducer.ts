import { IpmMc, DetalleIpmMc } from '../../../../consultas/models';
import { ConsultaState } from '../entity-state.model';
import { IpmMcActions, actions } from '../../actions/consultas/ipm-mc.actions';
import { RESOURCE_ACTIONS } from '../../../utils';

export const INITIAL_STATE: ConsultaState<IpmMc> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function ipmMcReducer(state = INITIAL_STATE, action: IpmMcActions): ConsultaState<IpmMc> {
  switch (action.type) {
    case actions.RESET:
      return {
      ...INITIAL_STATE
