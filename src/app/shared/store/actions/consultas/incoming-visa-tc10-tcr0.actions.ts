...
import { CriterioIncomingVisaTC10Request} from '../../../../consultas/models/criterios';

export const actions = {
  ...getCommonConsultaActions('IncomingVisaTC10TCR0'),
}

export class GetCriterioTC10TCR0 implements Action {
  readonly type = actions.GET_CRITERIO_PAGINADO;
  constructor(public payload: CriterioIncomingVisaTC10Request) {}
}
...
export class ResetTC10TCR0 implements Action {
  readonly type = actions.RESET;
  constructor(public payload = null) {}
}


export type IncomingVisaTC10TCR0Actions
  = GetCriterioTC10TCR0
